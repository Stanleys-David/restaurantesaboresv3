...
const statusClass = (status) => status === "reserved" ? "reserved" : status === "occupied" ? "occupied" : status === "available" || status === "libre" ? "available" : status === "cuenta_solicitada" ? "payment" : "other"
